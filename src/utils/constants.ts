...
export const TESTNET_CONSTANTS: SuiUSDEOptions = {
  ...
  collaterals: {
    dummyUsdc: {
      enable: true,
      aggregatedOracleId:
        "0x6ffc8f6f3e7c304a83de498fddde91761c9fb82ebf5bf98c045af98235916e5a",
      custodianAddress:
        "0xcf442edd34986d7926e92f14a21e03be84982ed73b79ed5310496bb1395be9d3",
...
export const MAINNET_CONSTANTS: SuiUSDEOptions = {
  ...
  collaterals: {
    usdc: {
      enable: true,
      aggregatedOracleId:
        "0x41247501fe86cc7257b9a59162cfaf2660376bdf74eb5bcb8abe238c91cb1170",
      // Custodian address to receive USDC -- Confirmed over email
      custodianAddress:
        "0x4c8f7a29a2c4b030bd1052754b5229d80984c1d580508eb378a6407a1ef9f1de",
  ...
  publishData: {
    treasuryCapObjectId:
      "0xae5039079b0cf2bb7694c24b411ea9fc24a1a59f602ca90b0ba2b2095da54bda",
    denyCapObjectId:
      "0xff3d56bc2319d860710b9981485f96dda6d602a79ddaad65224fb3811db95b66",
    metadataCapObjectId:
      "0x392eded8007863039e22a14dbbeaef09645c99e2fd915e33937905e474dba75f",
  },
};
