...
export interface EnableGlobalPauseArguments {
  treasury: RawTransactionArgument<string>;
  _: RawTransactionArgument<string>;
}
export interface EnableGlobalPauseOptions {
  package?: string;
  arguments:
    | EnableGlobalPauseArguments
    | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
      ];
}
export function enableGlobalPause(options: EnableGlobalPauseOptions) {
  const packageAddress = options.package ?? "@suiusde/suiusde";
  const argumentsTypes = [
    `${packageAddress}::treasury::Treasury`,
    `${packageAddress}::auth::Auth<${packageAddress}::roles::AdminRole>`,
...
export interface DisableGlobalPauseArguments {
  treasury: RawTransactionArgument<string>;
  _: RawTransactionArgument<string>;
}
export interface DisableGlobalPauseOptions {
  package?: string;
  arguments:
    | DisableGlobalPauseArguments
    | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
      ];
}
export function disableGlobalPause(options: DisableGlobalPauseOptions) {
  const packageAddress = options.package ?? "@suiusde/suiusde";
  const argumentsTypes = [
    `${packageAddress}::treasury::Treasury`,
    `${packageAddress}::auth::Auth<${packageAddress}::roles::AdminRole>`,
