...
export const CollateralKey = new MoveTuple({
  name: `${$moduleName}::CollateralKey`,
  fields: [bcs.bool()],
});
export const TreasuryCapKey = new MoveTuple({
...
export interface ShareOptions {
  package?: string;
  arguments: ShareArguments | [treasury: RawTransactionArgument<string>];
}
