...
export const CollateralConfig = new MoveStruct({ name: `${$moduleName}::CollateralConfig`, fields: {
...
export function _new(options: NewOptions) {
    ...
    const parameterNames = ["currency", "limits", "custodianAddress", "minOraclePrice", "maxOraclePrice", "maxOracleAge", "oracle", "defaultFee"];
