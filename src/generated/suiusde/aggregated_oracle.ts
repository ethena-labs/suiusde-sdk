...
export const AggregatedOracle = new MoveStruct({ name: `${$moduleName}::AggregatedOracle`, fields: {
        id: object.UID,
...
export const PythConfidenceBps = new MoveTuple({ name: `${$moduleName}::PythConfidenceBps`, fields: [bcs.bool()] });
