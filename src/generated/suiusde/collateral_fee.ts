...
export const CollateralFee = new MoveStruct({ name: `${$moduleName}::CollateralFee`, fields: {
...
export interface IsMintFeeExemptOptions {
    package?: string;
    arguments: IsMintFeeExemptArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface IsRedeemFeeExemptOptions {
    package?: string;
    arguments: IsRedeemFeeExemptArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface UseDefaultMintFeesOptions {
    package?: string;
    arguments: UseDefaultMintFeesArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface UseDefaultRedeemFeesOptions {
    package?: string;
    arguments: UseDefaultRedeemFeesArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface SetRedeemFeeOptions {
    package?: string;
    arguments: SetRedeemFeeArguments | [
        fee: RawTransactionArgument<string>,
        redeem: RawTransactionArgument<number>
    ];
}
...
export interface ApplyMintFeeExemptionOptions {
    package?: string;
    arguments: ApplyMintFeeExemptionArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface ApplyRedeemFeeExemptionOptions {
    package?: string;
    arguments: ApplyRedeemFeeExemptionArguments | [
        fee: RawTransactionArgument<string>
    ];
}
export function applyRedeemFeeExemption(options: ApplyRedeemFeeExemptionOptions) {
    const packageAddress = options.package ?? '@suiusde/suiusde';
    const argumentsTypes = [
        `${packageAddress}::collateral_fee::CollateralFee`
    ] satisfies string[];
...
export interface ApplyDefaultMintFeeOptions {
    package?: string;
    arguments: ApplyDefaultMintFeeArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface ApplyDefaultRedeemFeeOptions {
    package?: string;
    arguments: ApplyDefaultRedeemFeeArguments | [
        fee: RawTransactionArgument<string>
    ];
}
...
export interface CalculateMintFeeOptions {
    package?: string;
    arguments: CalculateMintFeeArguments | [
        fee: RawTransactionArgument<string>,
        defaultFee: RawTransactionArgument<string>
    ];
}
...
export interface CalculateRedeemFeeOptions {
    package?: string;
    arguments: CalculateRedeemFeeArguments | [
        fee: RawTransactionArgument<string>,
        defaultFee: RawTransactionArgument<string>
    ];
}
