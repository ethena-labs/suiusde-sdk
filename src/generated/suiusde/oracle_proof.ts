...
export const OraclePrice = new MoveStruct({ name: `${$moduleName}::OraclePrice`, fields: {
 ...
 * invalid.
 */
export const CommittedOraclePrice = new MoveEnum({ name: `${$moduleName}::CommittedOraclePrice`, fields: {
        Invalid: null,
        Valid: OraclePrice
    } });
export const OracleProof = new MoveStruct({ name: `${$moduleName}::OracleProof`, fields: {
