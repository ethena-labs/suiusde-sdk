...
export const EpochPeriodManagerRole = new MoveTuple({ name: `${$moduleName}::EpochPeriodManagerRole`, fields: [bcs.bool()] });
...
export interface SetGlobalEpochLimitsOptions {
    package?: string;
    arguments: SetGlobalEpochLimitsArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        limit: RawTransactionArgument<string>
    ];
...
export interface SetGlobalPeriodLimitsOptions {
    package?: string;
    arguments: SetGlobalPeriodLimitsArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        limit: RawTransactionArgument<string>
    ];
...
export interface SetDefaultBenefactorMaxMintPerEpochOptions {
    package?: string;
    arguments: SetDefaultBenefactorMaxMintPerEpochArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        maxMint: RawTransactionArgument<number | bigint>
    ];
...
export function setDefaultBenefactorMaxMintPerEpoch(options: SetDefaultBenefactorMaxMintPerEpochOptions) {
    const packageAddress = options.package ?? '@suiusde/suiusde';
    const argumentsTypes = [
        `${packageAddress}::treasury::Treasury`,
        `${packageAddress}::auth::Auth<${packageAddress}::epoch_period_manager::EpochPeriodManagerRole>`,
...
export interface SetDefaultBenefactorMaxRedeemPerEpochOptions {
    package?: string;
    arguments: SetDefaultBenefactorMaxRedeemPerEpochArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        maxRedeem: RawTransactionArgument<number | bigint>
    ];
...
export function setDefaultBenefactorMaxRedeemPerEpoch(options: SetDefaultBenefactorMaxRedeemPerEpochOptions) {
    const packageAddress = options.package ?? '@suiusde/suiusde';
    const argumentsTypes = [
        `${packageAddress}::treasury::Treasury`,
        `${packageAddress}::auth::Auth<${packageAddress}::epoch_period_manager::EpochPeriodManagerRole>`,
...
export interface SetDefaultBenefactorMaxMintPerPeriodOptions {
    package?: string;
    arguments: SetDefaultBenefactorMaxMintPerPeriodArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        maxMint: RawTransactionArgument<number | bigint>
    ];
...
export function setDefaultBenefactorMaxMintPerPeriod(options: SetDefaultBenefactorMaxMintPerPeriodOptions) {
    const packageAddress = options.package ?? '@suiusde/suiusde';
    const argumentsTypes = [
        `${packageAddress}::treasury::Treasury`,
        `${packageAddress}::auth::Auth<${packageAddress}::epoch_period_manager::EpochPeriodManagerRole>`,
...
export interface SetDefaultBenefactorMaxRedeemPerPeriodOptions {
    package?: string;
    arguments: SetDefaultBenefactorMaxRedeemPerPeriodArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        maxRedeem: RawTransactionArgument<number | bigint>
    ];
...
export function setDefaultBenefactorMaxRedeemPerPeriod(options: SetDefaultBenefactorMaxRedeemPerPeriodOptions) {
    const packageAddress = options.package ?? '@suiusde/suiusde';
    const argumentsTypes = [
        `${packageAddress}::treasury::Treasury`,
        `${packageAddress}::auth::Auth<${packageAddress}::epoch_period_manager::EpochPeriodManagerRole>`,
...
export interface SetEpochDurationOptions {
    package?: string;
    arguments: SetEpochDurationArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        durationMs: RawTransactionArgument<number | bigint>
    ];
...
export interface SetPeriodDurationOptions {
    package?: string;
    arguments: SetPeriodDurationArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        durationMs: RawTransactionArgument<number | bigint>
    ];
