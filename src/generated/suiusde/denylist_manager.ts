...
export const DenylistManagerRole = new MoveTuple({ name: `${$moduleName}::DenylistManagerRole`, fields: [bcs.bool()] });
...
export interface AddToDenylistOptions {
    package?: string;
    arguments: AddToDenylistArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        addr: RawTransactionArgument<string>
    ];
...
export interface RemoveFromDenylistOptions {
    package?: string;
    arguments: RemoveFromDenylistArguments | [
        treasury: RawTransactionArgument<string>,
        _: RawTransactionArgument<string>,
        addr: RawTransactionArgument<string>
    ];
