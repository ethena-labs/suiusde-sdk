...
export interface ExpiryMsOptions {
  package?: string;
  arguments: ExpiryMsArguments | [order: RawTransactionArgument<string>];
  typeArguments: [string];
}
...
export interface MinAmountOutOptions {
  package?: string;
  arguments: MinAmountOutArguments | [settings: RawTransactionArgument<string>];
  typeArguments: [string];
}
...
export interface NonceOptions {
  package?: string;
  arguments: NonceArguments | [settings: RawTransactionArgument<string>];
  typeArguments: [string];
}
...
export interface AmountInOptions {
  package?: string;
  arguments: AmountInArguments | [order: RawTransactionArgument<string>];
  typeArguments: [string];
}
