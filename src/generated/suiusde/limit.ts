...
export const Limit = new MoveStruct({
...
export interface MaxMintOptions {
  package?: string;
  arguments: MaxMintArguments | [limit: RawTransactionArgument<string>];
}
export function maxMint(options: MaxMintOptions) {
  const packageAddress = options.package ?? "@suiusde/suiusde";
  const argumentsTypes = [`${packageAddress}::limit::Limit`] satisfies string[];
...
export interface MaxRedeemOptions {
  package?: string;
  arguments: MaxRedeemArguments | [limit: RawTransactionArgument<string>];
}
